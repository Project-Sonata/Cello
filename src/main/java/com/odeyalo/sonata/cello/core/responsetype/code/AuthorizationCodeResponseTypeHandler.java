 ...
 */
@Component
public class AuthorizationCodeResponseTypeHandler implements Oauth2ResponseTypeHandler {
    ...
    public Mono<Oauth2AuthorizationResponse<? extends Oauth2AuthorizationRequest>> permissionGranted(@NotNull final Oauth2AuthorizationRequest authorizationRequest,
        ...
        return Mono.just(
                AuthorizationCodeResponse.withAssociatedRequest(authorizationCodeRequest).build()
        );
    }
}
